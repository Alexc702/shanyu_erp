...
export interface AuditRecord {
  readonly action:
    ...
    | "MAIN_MATERIAL_CATALOG_PUBLISHED"
    | "MAIN_MATERIAL_CATALOG_REFRESHED"
    | "MAIN_MATERIAL_IMPORT_VALIDATED"
    | "MAIN_MATERIAL_LINE_ADDED"
    | "MAIN_MATERIAL_LINE_REMOVED"
    | "MAIN_MATERIAL_ONLINE_EDIT_VALIDATED"
    | "MAIN_MATERIAL_SELECTION_UPDATED"
    | "PROJECT_CREATED"
    | "PROJECT_LEAD_TRANSFERRED"
    | "PROJECT_READONLY_REVOKED"
  ...
  readonly targetType:
    ...
    | "MAIN_MATERIAL_IMPORT_BATCH"
    | "MAIN_MATERIAL_QUOTATION"
    | "MAIN_MATERIAL_QUOTE_LINE"
    | "PROJECT"
    | "SESSION"
    | "SPACE"
    | "USER";
