                ...
                <TableBody>{filteredVisibleLines.map((line, index) => {
                  ...
                  return (
                    ...
                    <TableRow>
                      ...
                      <TableCell className="whitespace-normal break-words">{line.item ? <><strong className="block whitespace-normal break-words">{line.item.brand || "—"}</strong><span className="type-support block whitespace-normal break-words text-muted-foreground">{line.item.model || line.item.itemName}{line.selectedColor ? ` · ${line.selectedColor}` : ""}</span></> : <Badge variant="warning">待选择</Badge>}</TableCell>
